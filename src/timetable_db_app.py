...
def navigate_to_fk_table(n_clicks_list, button_ids):
...
def clear_input_fields(n_clicks_list, button_ids, input_ids):
...
def create_entry(n_clicks_list, input_values, input_ids, button_ids):
    ...
    try:
        ...
        # Create a result list with success message for the triggered table and empty strings for others
        result = []
